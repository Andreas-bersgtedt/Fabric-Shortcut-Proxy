...
from system_config import (
    ...
    # Fleet
    AGENT_COUNT, AGENT_SUPERVISION_MODE, AGENT_SHARD_INDEX, AGENT_SHARD_COUNT, SHARD_STRATEGY, ENABLE_GATEWAY, MATERIALIZE_WAIT_SECONDS,
    # Control Plane
...
_register("AGENT_SUPERVISION_MODE", "agent_supervision_mode", "str", AGENT_SUPERVISION_MODE)
...
def validate_config() -> None:
    ...
    if AGENT_SUPERVISION_MODE not in ("local", "external"):
        problems.append("AGENT_SUPERVISION_MODE must be 'local' or 'external'")
...
_KEY_TO_ATTR: dict[str, str] = {
    ...
    "agent_supervision_mode": "AGENT_SUPERVISION_MODE",
...
_SETTINGS_TO_FILE_MAP: dict[str, str] = {
    ...
    "open_mirror_max_pages_per_cycle": "config.system.json",
    "open_mirror_max_rows_per_cycle": "config.system.json",
    "open_mirror_self_healing": "config.system.json",
    "open_mirror_preflight_timeout_seconds": "config.system.json",
    "open_mirror_start_cooldown_seconds": "config.system.json",
    "open_mirror_fabric_retry_attempts": "config.system.json",
