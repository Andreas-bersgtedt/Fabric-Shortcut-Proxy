...
The repository's `docs/` manuals remain authoritative for detailed reference material. These skills are concise task procedures and should link to those manuals rather than duplicate every option.